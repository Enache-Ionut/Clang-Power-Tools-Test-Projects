...
CCalculatorApp::CCalculatorApp()
{
	...
	// TODO(horatiu.prica): add construction code here,
...
BOOL CCalculatorApp::InitInstance()
{
	...
	// TODO(horatiu.prica): You should modify this string to be something appropriate
	...
	if (nResponse == IDOK)
	{
		// TODO(horatiu.prica): Place code here to handle when the dialog is
		//  dismissed with OK
	}
